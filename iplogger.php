<?php //IPTools v2-----------------------------//
      //LOG SCRIPT v2--------------------------//
      //Revision: 062203-----------------------//
      //Copyright (c) Bjornx|Philippine Cyber Alliance--//
      
      //CONFIGURATION--------------------------------------------------------------------------//
      $webpagename = "solvers.php"; //Set this to the name of the webpage the script is added to

      date_default_timezone_set('Australia/Perth'); //Set to your Time Zone
      $date = "[" . date("d/m/Y h:i a") . "]"; //Default: Day, Month, Year, 12 hour time
      
      $logFile = 'geoip.txt'; //Directory & file log is written to
      //---------------------------------------------------------------------------------------//
